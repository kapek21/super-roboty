...
export const ROBOTS: readonly RobotDef[] = [
  {
    ...
    pages: [
      ...
      },
      {
        title: 'żółty wóz',
        slot: 'leg_left',
        bricks: [P('yellow-2x4', 2, 2), P('yellow-2x4', 2, 3), P('black-2x2', 4, 2)],
      ...
      },
      {
        title: 'czerwony wóz',
        slot: 'leg_right',
        bricks: [P('red-2x4', 8, 2), P('red-2x4', 8, 3), P('black-2x2', 10, 2)],
        decoys: ['green-2x4', 'orange-2x2'],
      },
      {
        title: 'biodra',
        slot: 'torso',
        bricks: [P('navy-2x4', 4, 3), P('navy-2x4', 6, 3)],
